...
const LogoControl = styled("ul",{
  ...
  marginTop: "clamp(1.0625rem, calc(1.0625rem + ((1vw - 0.2rem) * 0.3922)), 1.125rem)",

  // marginBottom:"28px", // 320
  // marginBottom:"29px", // 575
  /* 1.75rem(28px) @ 20rem(320px) increasing to 1.8125rem(29px) @ 35.9375rem(575px) */
  marginBottom: "clamp(1.75rem, calc(1.75rem + ((1vw - 0.2rem) * 0.3922)), 1.8125rem)",
...
const BottomLogoControl = styled("ul",{
  /* 5.0635rem(81.016px) @ 35.9375rem(575px) increasing to 12.1445rem(194.312px) @ 160rem(2560px) */
  width: "clamp(5.0635rem, calc(5.0635rem + ((1vw - 0.359375rem) * 5.7076)), 12.1445rem)",

  /* 2.1494375rem(34.391px) @ 35.9375rem(575px) increasing to 5.15625rem(82.5px) @ 160rem(2560px) */
  height: "clamp(2.1494375rem, calc(2.1494375rem + ((1vw - 0.359375rem) * 2.4236)), 5.15625rem)",

  /* 0.0625rem(1px) @ 35.9375rem(575px) increasing to 0.1875rem(3px) @ 160rem(2560px) */
  marginTop: "clamp(0.0625rem, calc(0.0625rem + ((1vw - 0.359375rem) * 0.1008)), 0.1875rem)",
